// eDMDoc.h : interface of the CeDMDoc class
//
/////////////////////////////////////////////////////////////////////////////
...
typedef CxImage*   pCxImage;

class CeDMDoc : public CDocument
{
protected: // create from serialization only
	CeDMDoc();
	DECLARE_DYNCREATE(CeDMDoc)
...
// Implementation
public:
	BOOL OnChangeImage(int nImage);
	BOOL OnOpenImage(LPCSTR lpszFileName, int nImage);
