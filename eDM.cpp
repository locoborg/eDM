// eDM.cpp : Defines the class behaviors for the application.
...
//////////////////////////////////////////////////////////////////////////////
// CeDMApp
BEGIN_MESSAGE_MAP(CeDMApp, CWinApp)
	//{{AFX_MSG_MAP(CeDMApp)
	...
	ON_COMMAND(ID_CXIMAGE_EDMSAVEMULTIPAGETIFF, OnCximageeDMsavemultipagetiff)
	ON_COMMAND(ID_CXIMAGE_EDMSAVEANIMATEDGIF, OnCximageeDMsaveanimatedgif)
	ON_COMMAND(ID_CXIMAGE_DOWNLOADFROMURL, OnCximageDownloadfromurl)
	//}}AFX_MSG_MAP
	// Standard file based document commands
	ON_COMMAND(ID_FILE_NEW, CWinApp::OnFileNew)
	ON_COMMAND(ID_FILE_OPEN, CeDMApp::OnFileOpen)
	// Standard print setup command
	ON_COMMAND(ID_FILE_PRINT_SETUP, CWinApp::OnFilePrintSetup)
END_MESSAGE_MAP()

//////////////////////////////////////////////////////////////////////////////
// CeDMApp construction
CeDMApp::CeDMApp()
{
	m_nDocCount=1; //counter for documents
}
//////////////////////////////////////////////////////////////////////////////
// The one and only CeDMApp object
CeDMApp theApp;

//////////////////////////////////////////////////////////////////////////////
// CeDMApp initialization
BOOL CeDMApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(
		IDR_EDMTYPE,
		RUNTIME_CLASS(CeDMDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CeDMView));
	eDMTemplate = pDocTemplate;
...
void CeDMApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
//////////////////////////////////////////////////////////////////////////////
void CeDMApp::OnFileOpen() 
{
...
BOOL CeDMApp::PromptForFileName(CString& fileName, UINT nIDSTitle, 
...
//////////////////////////////////////////////////////////////////////////////
int CeDMApp::GetIndexFromType(int nDocType, BOOL bOpenFileDialog)
{
	int nCnt = 0;
...
//////////////////////////////////////////////////////////////////////////////
int CeDMApp::GetTypeFromIndex(int nIndex, BOOL bOpenFileDialog)
{
	int nCnt = 0;
	for (int i=0;i<CMAX_IMAGE_FORMATS;i++){
		if (bOpenFileDialog ? doctypes[i].bRead : doctypes[i].bWrite){
...
//////////////////////////////////////////////////////////////////////////////
CString CeDMApp::GetExtFromType(int nDocType)
{
	for (int i=0;i<CMAX_IMAGE_FORMATS;i++){
...
//////////////////////////////////////////////////////////////////////////////
BOOL CeDMApp::GetWritableType(int nDocType){
	for (int i=0;i<CMAX_IMAGE_FORMATS;i++){
		if (doctypes[i].nID == nDocType)
...
//////////////////////////////////////////////////////////////////////////////
CString CeDMApp::GetFileTypes(BOOL bOpenFileDialog)
{
	CString str;
	for (int i=0;i<CMAX_IMAGE_FORMATS;i++){
...
//////////////////////////////////////////////////////////////////////////////
// CeDMApp commands
void CeDMApp::OnImageFromBitmap() 
{
/*	HBITMAP bitmap;
	...
	CeDMDoc *doc = (CeDMDoc *)eDMTemplate->OpenDocumentFile(NULL);
	if (doc){
		doc->image = newImage;
...
//////////////////////////////////////////////////////////////////////////////
void CeDMApp::OnCximageLoadjpegresource() 
{
	CxImage* newImage = new CxImage();
...
//////////////////////////////////////////////////////////////////////////////
void CeDMApp::OnCximageLoadiconresource() 
{
	CxImage* newImage = new CxImage();
...
//////////////////////////////////////////////////////////////////////////////
void CeDMApp::OnCximageLoadgifresource() 
{
	CxImage* newImage = new CxImage();
...
//////////////////////////////////////////////////////////////////////////////
void CeDMApp::OnCximageLoadpngresource() 
{
	CxImage* newImage = new CxImage();
...
//////////////////////////////////////////////////////////////////////////////
void CeDMApp::OnCximageLoadtifresource() 
{
	CxImage* newImage = new CxImage();
...
//////////////////////////////////////////////////////////////////////////////
void CeDMApp::OnCximageeDMsavemultipagetiff() 
{
...
//////////////////////////////////////////////////////////////////////////////
void CeDMApp::OnCximageeDMsaveanimatedgif() 
{
	CxImage* newImage = new CxImage();
	if (!newImage->LoadResource(FindResource(NULL,MAKEINTRESOURCE(IDR_GIF1),"GIF"),CXIMAGE_FORMAT_GIF)){
		AfxMessageBox(newImage->GetLastError());
...
//////////////////////////////////////////////////////////////////////////////
void CeDMApp::OnCximageDownloadfromurl() 
{
	DlgURL dlg;
	if (dlg.DoModal()==IDOK){
