// eDMView.cpp : implementation of the CeDMView class
//
...
IMPLEMENT_DYNCREATE(CeDMView, CScrollView)

BEGIN_MESSAGE_MAP(CeDMView, CScrollView)
	//{{AFX_MSG_MAP(CeDMView)
	ON_WM_MOUSEMOVE()
	ON_WM_ERASEBKGND()
	ON_WM_SETFOCUS()
	ON_WM_LBUTTONDOWN()
...
//////////////////////////////////////////////////////////////////////////////
// CeDMView construction/destruction
CeDMView::CeDMView()
{
...
//////////////////////////////////////////////////////////////////////////////
BOOL CeDMView::PreCreateWindow(CREATESTRUCT& cs)
{
...
//////////////////////////////////////////////////////////////////////////////
// CeDMView drawing
void CeDMView::OnDraw(CDC* pDC)
{
	CeDMDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);

	if(pDoc->imgList&&!imgDlg){
		CString s;
		imgDlg=new CImgList(this);
		imgDlg->Create(IDD_IMGLIST,this);
		imgDlg->m_imgList.SetImageList(pDoc->imgList,LVSIL_NORMAL);
		for(int i=0; i<pDoc->imgList->GetImageCount(); i++){
			s.Format("Page %d",i+1);
			imgDlg->m_imgList.InsertItem(i,s,i);
		}
	...
	if (ima) {
		if (bPrinting) {
			...
			tmp.SetTransColor(c);
			tmp.AlphaStrip();
			tmp.Stretch(pDC->GetSafeHdc(), CRect(0,0,cx,cy));
		}
	...
	//		else
			if(imgDlg){
				ima->Draw(pDC->GetSafeHdc(),
						CRect(102,0,(int)(ima->GetWidth()*zoom),(int)(ima->GetHeight()*zoom)));
				CRect rect;
				GetClientRect(&rect);
				//imgDlg->MoveWindow(rect.left+1,rect.top+1,101,rect.Height()-19);
				this->
				imgDlg->MoveWindow(0,0,102,rect.Height());
			}else
				ima->Draw(pDC->GetSafeHdc(),
...
//////////////////////////////////////////////////////////////////////////////
// CeDMView printing
BOOL CeDMView::OnPreparePrinting(CPrintInfo* pInfo)
{
	// default preparation
	pInfo->SetMaxPage(1);
...
//////////////////////////////////////////////////////////////////////////////
void CeDMView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// TODO: add extra initialization before printing
}
//////////////////////////////////////////////////////////////////////////////
void CeDMView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// TODO: add cleanup after printing
}
//////////////////////////////////////////////////////////////////////////////
// CeDMView diagnostics
#ifdef _DEBUG
void CeDMView::AssertValid() const
{
	CScrollView::AssertValid();
}
//////////////////////////////////////////////////////////////////////////////
void CeDMView::Dump(CDumpContext& dc) const
{
	CScrollView::Dump(dc);
}
//////////////////////////////////////////////////////////////////////////////
CeDMDoc* CeDMView::GetDocument() // non-debug version is inline
{
	ASSERT(m_pDocument->IsKindOf(RUNTIME_CLASS(CeDMDoc)));
	return (CeDMDoc*)m_pDocument;
}
#endif //_DEBUG

//////////////////////////////////////////////////////////////////////////////
void CeDMView::GetImageXY(CeDMDoc *pDoc, CxImage *ima, long *x, long *y)
{
	if (!ima || !pDoc) return;
...
//////////////////////////////////////////////////////////////////////////////
// CeDMView message handlers
//////////////////////////////////////////////////////////////////////////////
void CeDMView::OnMouseMove(UINT nFlags, CPoint point) 
{
	CeDMDoc* pDoc = GetDocument();
	CxImage*  ima  = pDoc->GetImage();
	if (!ima)	return;
...
//////////////////////////////////////////////////////////////////////////////
BOOL CeDMView::OnEraseBkgnd(CDC* pDC) 
{
	return 1;
}
//////////////////////////////////////////////////////////////////////////////
void CeDMView::OnSetFocus(CWnd* pOldWnd) 
{
...
//////////////////////////////////////////////////////////////////////////////
void CeDMView::OnLButtonDown(UINT nFlags, CPoint point) 
{
	CeDMDoc* pDoc = GetDocument();
	if (pDoc) {
		switch(pDoc->m_tool){
...
//////////////////////////////////////////////////////////////////////////////
void CeDMView::OnLButtonUp(UINT nFlags, CPoint point) 
{
#if CXIMAGE_eDM_SELECT
	CeDMDoc* pDoc = GetDocument();
	if (pDoc){
...
#endif
	// Add a obejct to the window with CLSIDFromProgID 
	CScrollView::OnLButtonUp(nFlags, point);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMView::OnUpdate(CView* pSender, LPARAM lHint, CObject* pHint) 
{
	switch (lHint)
	{
...
//////////////////////////////////////////////////////////////////////////////
void CeDMView::OnContextMenu(CWnd* pWnd, CPoint point) 
{
	CeDMDoc* pDoc = GetDocument();
...
//////////////////////////////////////////////////////////////////////////////
LRESULT CeDMView::OnNewImage(WPARAM wParam, LPARAM lParam)
{
	CeDMDoc* pDoc = GetDocument();
...
//////////////////////////////////////////////////////////////////////////////
LRESULT CeDMView::OnNewProgress(WPARAM wParam, LPARAM lParam)
{
	CStatusBar& statusBar = ((CMainFrame *)(AfxGetApp()->m_pMainWnd))->GetStatusBar();
	CString s;
...
//////////////////////////////////////////////////////////////////////////////
#if CXIMAGE_eDM_SELECT
void CALLBACK LineDDAProc(int x, int y, CeDMView *pview)
{
	CDC* pDC = pview->GetDC();
	if (pDC) {
		pview->m_SelCount++;
...
//////////////////////////////////////////////////////////////////////////////
void CeDMView::OnTimer(UINT nIDEvent) 
{
#if CXIMAGE_eDM_SELECT
	m_SelShift++;
...
//////////////////////////////////////////////////////////////////////////////
void CeDMView::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
	if (nChar == VK_ESCAPE){
		CMainFrame* pMain = (CMainFrame*) AfxGetMainWnd();
...
//////////////////////////////////////////////////////////////////////////////
void CeDMView::OnRButtonDown(UINT nFlags, CPoint point) 
{
	CeDMDoc* pDoc = GetDocument();
	if (pDoc) {
		switch(pDoc->m_tool){
...
void CeDMView::OnActivateView(BOOL bActivate, CView* pActivateView, CView* pDeactiveView) 
{
	if (bActivate){
		((CMainFrame*)AfxGetMainWnd())->m_HistoBar.Invalidate();
	}
...
void CeDMView::OnVScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) 
{
	// TODO: Add your message handler code here and/or call default
	if(imgDlg) imgDlg->ShowWindow(SW_HIDE);
	CScrollView::OnVScroll(nSBCode, nPos, pScrollBar);
	if(imgDlg) imgDlg->ShowWindow(SW_SHOW);
}

void CeDMView::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) 
{
	// TODO: Add your message handler code here and/or call default
	if(imgDlg) imgDlg->ShowWindow(SW_HIDE);
