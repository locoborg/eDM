// eDMDoc.cpp : implementation of the CeDMDoc class
//
...
IMPLEMENT_DYNCREATE(CeDMDoc, CDocument)

BEGIN_MESSAGE_MAP(CeDMDoc, CDocument)
	//{{AFX_MSG_MAP(CeDMDoc)
...
//////////////////////////////////////////////////////////////////////////////
// CeDMDoc construction/destruction
CeDMDoc::CeDMDoc()
{
	image = NULL;
...
//////////////////////////////////////////////////////////////////////////////
// CeDMDoc serialization
void CeDMDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())	{ } 
	else { }
}
...
// CeDMDoc diagnostics
#ifdef _DEBUG
void CeDMDoc::AssertValid() const
{
	CDocument::AssertValid();
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
//////////////////////////////////////////////////////////////////////////////
// CeDMDoc commands
CString CeDMDoc::FindExtension(const CString& name)
{
...
//////////////////////////////////////////////////////////////////////////////
int CeDMDoc::FindType(const CString& ext)
{
	int type = 0;
...
//////////////////////////////////////////////////////////////////////////////
BOOL CeDMDoc::OnOpenDocument(LPCTSTR lpszPathName) 
{
	...
	nTotalFrames=image->GetNumFrames();
	if (nTotalFrames>1){
		pImage =new pCxImage[nTotalFrames];
		imgList=new CImageList();

		CxImage *newImage=new CxImage();
		pImage[0]=new CxImage(*image);
		imgList->Create(48, 62, ILC_COLOR, 0, 4);

		pImage[0]->Resample(48,62,1,newImage);
		imgList->Add(CBitmap::FromHandle(newImage->MakeBitmap()),RGB(255,0,0));
		delete newImage;
		...
		for(int i=1;i<nTotalFrames;i++){
			pImage[i]=new CxImage();
			newImage = new CxImage();
			pImage[i]->SetFrame(i);
			pImage[i]->Load(filename,type);
			pImage[i]->Resample(48,62,1,newImage);
			imgList->Add(CBitmap::FromHandle(newImage->MakeBitmap()),RGB(255,0,0));
			delete newImage;
		}
	}
...
//////////////////////////////////////////////////////////////////////////////
BOOL CeDMDoc::OnSaveDocument(LPCTSTR lpszPathName) 
{
	CString filename(lpszPathName);
	CString ext(FindExtension(filename));
	ext.MakeLower();
	...
	if(nTotalFrames>1){
		...
		pImage[nImageFrame]->Copy(*image);
		retval=image->Encode(hFile,pImage,nTotalFrames,type);
...
//////////////////////////////////////////////////////////////////////////////
BOOL CeDMDoc::DoSave(LPCTSTR pszPathName, BOOL bReplace /*=TRUE*/)
{
...
int CeDMDoc::ComputePixel(float x, float y, float &x1, float &y1)
{
  double r, nn;
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnUpdateFileSaveAs(CCmdUI* pCmdUI) 
{
	pCmdUI->Enable(!(image==0 || hThread));
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnUpdateFileSave(CCmdUI* pCmdUI) 
{
	pCmdUI->Enable(0);
//	pCmdUI->Enable((image != NULL)); //&& theApp.GetWritableType(image->GetType()));
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnStretchMode() 
{
	stretchMode = !stretchMode;
	UpdateAllViews(NULL);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnUpdateStretchMode(CCmdUI* pCmdUI) 
{
	pCmdUI->SetCheck(stretchMode);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnUpdateCximageFlip(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageGrayscale(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageMirror(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageNegative(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageResample(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageRotate(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageRotater(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageRotatel(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageDither(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageThreshold(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageSplityuv(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageSplitrgb(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageSplithsl(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageSplityiq(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageSplitxyz(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageSplitcmyk(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximagePseudocolors(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageFiltersColorize(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageLighten(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageDarken(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageContrast(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageEmboss(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageBlur(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageDilate(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageEdge(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageErode(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageSharpen(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageSoften(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageCrop(CCmdUI* pCmdUI) 
{	if(image==0 || hThread || !image->SelectionIsValid()) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageRemovealphachannel(CCmdUI* pCmdUI) 
{	if(image==0 || hThread || !image->AlphaIsValid()) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageInvetalpha(CCmdUI* pCmdUI) 
{	if(image==0 || hThread || !image->AlphaIsValid()) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageAlphapalettetoggle(CCmdUI* pCmdUI) 
{	if(image==0 || hThread || !image->AlphaPaletteIsValid()) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageAlphastrip(CCmdUI* pCmdUI) 
{	if(image==0 || hThread || (!image->AlphaIsValid() && !image->AlphaPaletteIsValid())) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageRemovetransparency(CCmdUI* pCmdUI) 
{	if(image==0 || hThread || image->GetTransIndex()<0) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageGamma(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageMedian(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageAddnoise(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageCombine(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageFft(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageRepair(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageAlphachannelSplit(CCmdUI* pCmdUI) 
{	if(image==0 || hThread || !image->AlphaIsValid()) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageFiltersLog(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageFiltersRoot(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageHistogramEqualize(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageHistogramNormalize(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageHistogramStretch(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageGaussian3x3(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageGaussian5x5(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageContour(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageLesscontrast(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateCximageJitter(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}
void CeDMDoc::OnUpdateWindowDuplicate(CCmdUI* pCmdUI) 
{	if(image==0 || hThread) pCmdUI->Enable(0);}

//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnUpdateTransformEllipse(CCmdUI* pCmdUI) 
{
	if (image==NULL) pCmdUI->Enable(0);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnTransformEllipse() 
{
	SubmitUndo();
	DWORD x, y, x1, y1;
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnWindowDuplicate() 
{
	CeDMDoc *NewDoc=(CeDMDoc*)((CeDMApp*)AfxGetApp())->eDMTemplate->OpenDocumentFile(NULL); 
	...
	if (NewDoc)	{
		...
		CString s;
		s.Format("Copy %d of %s",((CeDMApp*)AfxGetApp())->m_nDocCount++,GetTitle());
		NewDoc->SetTitle(s);
		NewDoc->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnUpdateEditCopy(CCmdUI* pCmdUI) 
{
	if (image==NULL) pCmdUI->Enable(0);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnEditCopy() 
{
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnUpdateEditUndo(CCmdUI* pCmdUI) 
{
	if(image==0 || hThread) pCmdUI->Enable(0);
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnUpdateEditRedo(CCmdUI* pCmdUI) 
{
	if(image==0 || hThread) pCmdUI->Enable(0);
	...
	case ID_CXIMAGE_DECREASEBPP:
		{
			...
			if (method==1){
				...
				pDoc->image->DecreaseBpp(bit,errordiffusion,ppal);
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageIncreasebpp() 
{
	if (image==NULL) return;
	DlgIncBpp dlg;
	dlg.m_bit=24;
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageRotatel() 
{
	m_MenuCommand=ID_CXIMAGE_ROTATEL;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageRotater() 
{
	m_MenuCommand=ID_CXIMAGE_ROTATER;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageRotate() 
{
	if (image==NULL) return;
	DlgRotate dlg;
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageResample() 
{
	if (image==NULL) return;
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnUpdateViewZoomin(CCmdUI* pCmdUI) 
{
	if (stretchMode) pCmdUI->Enable(0);
	if (m_ZoomFactor>=16) pCmdUI->Enable(0);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnUpdateViewZoomout(CCmdUI* pCmdUI) 
{
	if (stretchMode) pCmdUI->Enable(0);
	if (m_ZoomFactor<=0.125) pCmdUI->Enable(0);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnViewNormalviewing11() 
{
	m_ZoomFactor=1;
	UpdateAllViews(NULL,WM_USER_NEWIMAGE);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnUpdateViewNormalviewing11(CCmdUI* pCmdUI) 
{
	if (stretchMode) pCmdUI->Enable(0);
	if (m_ZoomFactor==1) pCmdUI->Enable(0);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnUpdateCximageSettransparency(CCmdUI* pCmdUI) 
{
	if (image && hThread==0) pCmdUI->Enable(1);
	else pCmdUI->Enable(0);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageRemovetransparency() 
{
	SubmitUndo();
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageSettransparency() 
{
	m_WaitingClick=TRUE;
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::Stopwatch(int start0stop1)
{
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageThreshold() 
{
	if (image==NULL) return;
	DlgThreshold dlg;
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageSplitrgb() 
{
	if (image==NULL) return;
	...
	((CeDMApp*)AfxGetApp())->m_nDocCount++;
	CeDMDoc *NewDocr=(CeDMDoc*)((CeDMApp*)AfxGetApp())->eDMTemplate->OpenDocumentFile(NULL); 
	if (NewDocr)	{
		NewDocr->image = newr;
		CString s;
		s.Format("Red Channel %d from %s",((CeDMApp*)AfxGetApp())->m_nDocCount,GetTitle());
		NewDocr->SetTitle(s);
		NewDocr->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
	CeDMDoc *NewDocg=(CeDMDoc*)((CeDMApp*)AfxGetApp())->eDMTemplate->OpenDocumentFile(NULL); 
	if (NewDocg)	{
		NewDocg->image = newg;
		CString s;
		s.Format("Green Channel %d from %s",((CeDMApp*)AfxGetApp())->m_nDocCount,GetTitle());
		NewDocg->SetTitle(s);
		NewDocg->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
	CeDMDoc *NewDocb=(CeDMDoc*)((CeDMApp*)AfxGetApp())->eDMTemplate->OpenDocumentFile(NULL); 
	if (NewDocb)	{
		NewDocb->image = newb;
		CString s;
		s.Format("Blue Channel %d from %s",((CeDMApp*)AfxGetApp())->m_nDocCount,GetTitle());
		NewDocb->SetTitle(s);
		NewDocb->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageSplityuv() 
{
	if (image==NULL) return;
	...
	if (NewDocr)	{
		NewDocr->image = newr;
		CString s;
		s.Format("Y Channel %d from %s",((CeDMApp*)AfxGetApp())->m_nDocCount,GetTitle());
		NewDocr->SetTitle(s);
		NewDocr->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
	CeDMDoc *NewDocg=(CeDMDoc*)((CeDMApp*)AfxGetApp())->eDMTemplate->OpenDocumentFile(NULL); 
	if (NewDocg)	{
		NewDocg->image = newg;
		CString s;
		s.Format("U Channel %d from %s",((CeDMApp*)AfxGetApp())->m_nDocCount,GetTitle());
		NewDocg->SetTitle(s);
		NewDocg->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
	CeDMDoc *NewDocb=(CeDMDoc*)((CeDMApp*)AfxGetApp())->eDMTemplate->OpenDocumentFile(NULL); 
	if (NewDocb)	{
		NewDocb->image = newb;
		CString s;
		s.Format("V Channel %d from %s",((CeDMApp*)AfxGetApp())->m_nDocCount,GetTitle());
		NewDocb->SetTitle(s);
		NewDocb->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageSplithsl() 
{
	if (image==NULL) return;
	...
	if (NewDocr)	{
		NewDocr->image = newr;
		CString s;
		s.Format("Hue Channel %d from %s",((CeDMApp*)AfxGetApp())->m_nDocCount,GetTitle());
		NewDocr->SetTitle(s);
		NewDocr->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
	CeDMDoc *NewDocg=(CeDMDoc*)((CeDMApp*)AfxGetApp())->eDMTemplate->OpenDocumentFile(NULL); 
	if (NewDocg)	{
		NewDocg->image = newg;
		CString s;
		s.Format("Saturation Channel %d from %s",((CeDMApp*)AfxGetApp())->m_nDocCount,GetTitle());
		NewDocg->SetTitle(s);
		NewDocg->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
	CeDMDoc *NewDocb=(CeDMDoc*)((CeDMApp*)AfxGetApp())->eDMTemplate->OpenDocumentFile(NULL); 
	if (NewDocb)	{
		NewDocb->image = newb;
		CString s;
		s.Format("Lightness Channel %d from %s",((CeDMApp*)AfxGetApp())->m_nDocCount,GetTitle());
		NewDocb->SetTitle(s);
		NewDocb->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageSplitcmyk() 
{
	if (image==NULL) return;
	...
	if (NewDocr)	{
		NewDocr->image = newc;
		CString s;
		s.Format("C Channel %d from %s",((CeDMApp*)AfxGetApp())->m_nDocCount,GetTitle());
		NewDocr->SetTitle(s);
		NewDocr->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
	CeDMDoc *NewDocg=(CeDMDoc*)((CeDMApp*)AfxGetApp())->eDMTemplate->OpenDocumentFile(NULL); 
	if (NewDocg)	{
		NewDocg->image = newm;
		CString s;
		s.Format("M Channel %d from %s",((CeDMApp*)AfxGetApp())->m_nDocCount,GetTitle());
		NewDocg->SetTitle(s);
		NewDocg->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
	CeDMDoc *NewDocb=(CeDMDoc*)((CeDMApp*)AfxGetApp())->eDMTemplate->OpenDocumentFile(NULL); 
	...
	CeDMDoc *NewDock=(CeDMDoc*)((CeDMApp*)AfxGetApp())->eDMTemplate->OpenDocumentFile(NULL); 
	if (NewDock)	{
		NewDock->image = newk;
		CString s;
		s.Format("K Channel %d from %s",((CeDMApp*)AfxGetApp())->m_nDocCount,GetTitle());
		NewDock->SetTitle(s);
		NewDock->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximagePseudocolors() 
{
	if (image==NULL) return;
...
/*	POSITION pos = GetFirstViewPosition();
	CeDMView* pView = (CeDMView*)GetNextView(pos);
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageFiltersColorize() 
{
	if (image==NULL) return;
	DlgColorize dlg;
	dlg.m_sat=50;
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageDarken() 
{
	m_MenuCommand=ID_CXIMAGE_DARKEN;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageLighten() 
{
	m_MenuCommand=ID_CXIMAGE_LIGHTEN;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageContrast() 
{
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageEmboss() 
{
	m_MenuCommand=ID_CXIMAGE_EMBOSS;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageBlur() 
{
	m_MenuCommand=ID_CXIMAGE_BLUR;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageDilate() 
{
	m_MenuCommand=ID_CXIMAGE_DILATE;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageEdge() 
{
	m_MenuCommand=ID_CXIMAGE_EDGE;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageErode() 
{
	m_MenuCommand=ID_CXIMAGE_ERODE;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageSharpen() 
{
	m_MenuCommand=ID_CXIMAGE_SHARPEN;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageSoften() 
{
	m_MenuCommand=ID_CXIMAGE_SOFTEN;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageCrop() 
{
	SubmitUndo();
	RECT r;
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageRemovealphachannel() 
{
	SubmitUndo();
	image->AlphaDelete();
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageInvetalpha() 
{
	SubmitUndo();
	image->AlphaInvert();
	UpdateAllViews(NULL);
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageAlphapalettetoggle() 
{
	SubmitUndo();
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageAlphastrip() 
{
	SubmitUndo();
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageMedian() 
{
	m_MenuCommand=ID_CXIMAGE_MEDIAN;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageAddnoise() 
{
	m_MenuCommand=ID_CXIMAGE_ADDNOISE;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnViewToolsMove() 
{
	m_tool=0;
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnUpdateViewToolsMove(CCmdUI* pCmdUI) 
{
	pCmdUI->SetCheck(m_tool==0);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnViewToolsSelect() 
{
	m_tool=1;
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnUpdateViewToolsSelect(CCmdUI* pCmdUI) 
{
	pCmdUI->SetCheck(m_tool==1);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnViewToolsZoom() 
{
	m_tool=2;
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnUpdateViewToolsZoom(CCmdUI* pCmdUI) 
{
	pCmdUI->SetCheck(m_tool==2);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnViewToolsText() 
{
	if (image==NULL) return;
	DlgText dlg;
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnUpdateViewToolsText(CCmdUI* pCmdUI) 
{
	pCmdUI->SetCheck(m_tool==3);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnUpdateViewPalette(CCmdUI* pCmdUI) 
{
	if(image==0 || hThread || image->GetNumColors()==0) pCmdUI->Enable(0);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnViewPalette() 
{
	if (image==NULL) return;
	DlgPalette dlg;
...
void CeDMDoc::OnCximageCombine() 
{
	...
	if (dlg.DoModal()==IDOK){
		...
		if (NewDocr)	{
			NewDocr->image = mix;
			CString s;
			s.Format("NewImage%d",((CeDMApp*)AfxGetApp())->m_nDocCount++);
			NewDocr->SetTitle(s);
			NewDocr->UpdateAllViews(0,WM_USER_NEWIMAGE);
		}
...
void CeDMDoc::OnCximageFft() 
{
	...
	if (dlg.DoModal()==IDOK){
		...
		((CeDMApp*)AfxGetApp())->m_nDocCount++;
		CeDMDoc *NewDoci=(CeDMDoc*)((CeDMApp*)AfxGetApp())->eDMTemplate->OpenDocumentFile(NULL); 
		if (NewDoci)	{
			NewDoci->image = dsti;
			CString s;
			if (dlg.bMagnitude){
				s.Format("FFT Phase %d",((CeDMApp*)AfxGetApp())->m_nDocCount);
			} else {
				s.Format("FFT Imag %d",((CeDMApp*)AfxGetApp())->m_nDocCount);
			}
			NewDoci->SetTitle(s);
		...
		if (NewDocr)	{
			...
			CString s;
			if (dlg.bMagnitude){
				s.Format("FFT Magnitude %d",((CeDMApp*)AfxGetApp())->m_nDocCount);
			} else {
				s.Format("FFT Real %d",((CeDMApp*)AfxGetApp())->m_nDocCount);
			}
			NewDocr->SetTitle(s);
			NewDocr->UpdateAllViews(0,WM_USER_NEWIMAGE);
		}
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageSplityiq() 
{
	if (image==NULL) return;
	...
	if (NewDocg)	{
		NewDocg->image = newg;
		CString s;
		s.Format("I Channel %d from %s",((CeDMApp*)AfxGetApp())->m_nDocCount,GetTitle());
		NewDocg->SetTitle(s);
		NewDocg->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
	CeDMDoc *NewDocb=(CeDMDoc*)((CeDMApp*)AfxGetApp())->eDMTemplate->OpenDocumentFile(NULL); 
	if (NewDocb)	{
		NewDocb->image = newb;
		CString s;
		s.Format("Q Channel %d from %s",((CeDMApp*)AfxGetApp())->m_nDocCount,GetTitle());
		NewDocb->SetTitle(s);
		NewDocb->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageSplitxyz() 
{
	if (image==NULL) return;
	...
	if (NewDocr)	{
		NewDocr->image = newr;
		CString s;
		s.Format("X Channel %d from %s",((CeDMApp*)AfxGetApp())->m_nDocCount,GetTitle());
		NewDocr->SetTitle(s);
		NewDocr->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
	CeDMDoc *NewDocg=(CeDMDoc*)((CeDMApp*)AfxGetApp())->eDMTemplate->OpenDocumentFile(NULL); 
	...
	if (NewDocb)	{
		NewDocb->image = newb;
		CString s;
		s.Format("Z Channel %d from %s",((CeDMApp*)AfxGetApp())->m_nDocCount,GetTitle());
		NewDocb->SetTitle(s);
		NewDocb->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageRepair() 
{
	if (image==NULL) return;
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageAlphachannelSplit() 
{
	if (image==NULL) return;
	...
	if (NewDocr)	{
		NewDocr->image = newa;
		CString s;
		s.Format("Alpha Channel %d from %s",((CeDMApp*)AfxGetApp())->m_nDocCount,GetTitle());
		NewDocr->SetTitle(s);
		NewDocr->UpdateAllViews(0,WM_USER_NEWIMAGE);
	}
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageAlphaCreate() 
{
	if (image==NULL) return;
...
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageFiltersLog() 
{
	m_MenuCommand=ID_CXIMAGE_HISTOGRAM_LOG;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageFiltersRoot() 
{
	m_MenuCommand=ID_CXIMAGE_HISTOGRAM_ROOT;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageHistogramEqualize() 
{
	m_MenuCommand=ID_CXIMAGE_HISTOGRAM_EQUALIZE;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageHistogramNormalize() 
{
	m_MenuCommand=ID_CXIMAGE_HISTOGRAM_NORMALIZE;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageHistogramStretch() 
{
	m_MenuCommand=ID_CXIMAGE_HISTOGRAM_STRETCH;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageGaussian3x3() 
{
	m_MenuCommand=ID_CXIMAGE_GAUSSIAN3X3;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageGaussian5x5() 
{
	m_MenuCommand=ID_CXIMAGE_GAUSSIAN5X5;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageContour() 
{
	m_MenuCommand=ID_CXIMAGE_CONTOUR;
	hThread=(HANDLE)_beginthread(RunCxImageThread,0,this);
}
//////////////////////////////////////////////////////////////////////////////
void CeDMDoc::OnCximageLesscontrast() 
{
...
BOOL CeDMDoc::OnOpenImage(LPCSTR lpszFileName, int nImage)
{
	...
	if(nImage>=nTotalFrames) nImage=nTotalFrames-1;
	csFileName=filename;
	nImageFrame=nImage;

	Stopwatch(0);
	image = new CxImage();
	image->SetFrame(nImage);
...
BOOL CeDMDoc::OnChangeImage(int nImage)
{
	if(nImage<0) nImage=0;
	if(nImage>=nTotalFrames) nImage=nTotalFrames-1;
	// store current image in array
	pImage[nImageFrame]->Copy(*image);
	// Set new image to display
	nImageFrame=nImage;
	image->Copy(*pImage[nImage]);
